...
NAI = {
	...
	CALL_ALLY_DEMOCRATIC_DESIRE = 50,			-- Desire to call ally added for liberal AI
	...
	CALL_ALLY_COMMUNIST_DESIRE = 75,			-- Desire to call ally added for communism AI
	...
	JOIN_ALLY_DEMOCRATIC_DESIRE = 50,			-- Desire to join ally added for liberal AI
	...
	JOIN_ALLY_COMMUNIST_DESIRE = 75,			-- Desire to join ally added for communism AI
	...
	DEMOCRATIC_AI_FACTION_KICKING_PLAYER_THREAT_DIFFERENCE = 6.0, -- World threat generation difference needed to kick a player from a liberal faction
	BEFRIEND_FACTOR_FOR_KICKING_COUNTRIES = 7.5,		-- World threat difference addition per 100 befriend against a country, liberal leaders will forgive allies if they are befriending them
